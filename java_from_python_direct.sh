...
osascript -e 'tell app "Terminal"
    do script "cd ~/code/multi_lang_beam_summit_2023/java_from_python && java -jar beam-examples-multi-language-2.48.0.jar 5001"
end tell'
...
python javacount.py --runner DirectRunner --environment_type=DOCKER --input input1 --output output/counts --expansion_service_port 5001
